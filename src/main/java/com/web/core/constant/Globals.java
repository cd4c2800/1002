...
public class Globals {
	public final static String DEFAULT_SYSTEM_TITLE = "祥平鞋业";// 系统默认名称
	...
	public final static String DEFAULT_WBESITE_NAME = "shoes";// 软件名称
	...
	public final static String DEFAULT_SYSTEM_PAGE_ROOT = "WEB-INF/";// 默认系统页面根路径
	...
	public final static String DEFAULT_TABLE_SUFFIX = "ada_";// 默认表前缀名
	...
	public final static String SHARE_LINK="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxda2444ee42fb0c10&redirect_uri=http://shufugege.iask.in/wap/index.htm?id=1968&response_type=code&scope=snsapi_userinfo&state=#wechat_redirect";
}
